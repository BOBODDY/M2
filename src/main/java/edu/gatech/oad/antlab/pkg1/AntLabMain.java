 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Joseph Rossi");
		  toPrint += p1.toString("jrossi6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Kody Laseter");
		  toPrint += p2.toString("klaseter3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Chris Nathan");
		  toPrint += p3.toString("cnathan3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Brandon Shum");
                  toPrint += p4.toString("bshum3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Nick Mathews");
                  toPrint += p5.toString("nmathews6");
